 ...
 */
//@Component
public class ProcessVehicleListener implements ServletContextListener {
    private static final Logger logger = LoggerFactory.getLogger(ProcessVehicleListener.class);
    @Resource

...
public class FixedRegulation {
     ...
     * @return
     */
    public static List<TrafficLight> assignSignalControl(List<TrafficLight> trafficLightList, List<FlowRecord> recordList, List<GreenWave> waveList){
        ...
        //绿波协同控制
        GreenWaveRegulation greenWaveRegulation = new GreenWaveRegulation(junctionCoupleMap, junctionCycleMap, trafficLightMap);
